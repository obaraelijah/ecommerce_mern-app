...
import { faArrowRightToBracket, faEnvelope, faHeart, faShoppingBag, faUser } from '@fortawesome/free-solid-svg-icons'
...
const Navbar = () => {
  ...
  return (
    <div className='n-container'>
      <div className="n-row">
          <div className="n-col">
            <span className='n-email'>elijahobara357@gmail.com</span>
            {
