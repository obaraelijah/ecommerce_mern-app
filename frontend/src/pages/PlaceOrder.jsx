            ...
            <div className="order-row">
                ...
                <div className="order-col">
                    ...
                    <div className="order-summary-info">
                        <h4>Items</h4>
                        <span>Ksh.{cart.itemsPrice.toFixed(2)}</span>
                    </div>
                    <div className="order-summary-info">
                        <h4>Shipping</h4>
                        <span>Ksh.{cart.shippingPrice.toFixed(2)}</span>
                    </div>
                    <div className="order-summary-info">
                        <h4>Tax</h4>
                        <span>Ksh.{cart.taxPrice.toFixed(2)}</span>
                    </div>
                    <div className="order-summary-info">
                        <h3>Total</h3>
                        <span>Ksh.{cart.totalPrice.toFixed(2)}</span>
                    </div>
